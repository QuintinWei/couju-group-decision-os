...
export const CITY_PROFILES = {
  ...
  南京: { area: "鼓楼区", center: [118.7969, 32.0603], districts: ["鼓楼区", "玄武区", "秦淮区", "建邺区", "雨花台区"] },
  重庆: { area: "渝中区", center: [106.5516, 29.563], districts: ["渝中区", "江北区", "南岸区", "沙坪坝区", "九龙坡区"] },
  苏州: { area: "姑苏区", center: [120.5853, 31.2989], districts: ["姑苏区", "工业园区", "虎丘区", "吴中区", "相城区"] },
  合肥: { area: "蜀山区", center: [117.2272, 31.8206], districts: ["蜀山区", "庐阳区", "包河区", "瑶海区", "滨湖新区"] },
} as const;
